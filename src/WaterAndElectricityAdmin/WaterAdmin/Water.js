...
class Water extends Component {
  ...
  handleSubmit = (event) => {
    ...
    axios.post(process.env.ilyas + 'fournisseur/addFournisseur', formData, {
      headers: {
  ...
  componentDidMount() {
    console.log(process.env.ilyas + 'fournisseur/allFournisseur')
    fetch(process.env.REACT_APP_URL + ':8082/fournisseur/allFournisseur')
  ...
  deleteData = (itemToDelete) => {
    axios.delete(process.env.REACT_APP_URL + `:8082/fournisseur/delete/${itemToDelete.id_fournisseur}`)
      .then(res => {
