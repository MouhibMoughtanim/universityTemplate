...
export default function CreateFacture() {
    ...
    const onSubmit = (e) => {
        ...
        fetch(ipURL+ ':8081/factElec/addFactElec', {
            method: 'post',
            body: formData
        }).then(res => {
            if (res.ok) {
    ...
    const loadFacts = async () => {
        const result = await axios.get(ipURL+ ":8081/factElec/factElecs");
        setFacts(result.data);

    }

    const loadFactsP = async () => {
        const result = await axios.get(ipURL + ":8081/factElec/factElecsPaye");
        setFactsP(result.data);

    }

    const loadFactsNP = async () => {
        const result = await axios.get(process.env.React_App_URLd + "factElec/factElecsNonPaye");
        setFactsNP(result.data);

    }

    const loadFactsRef = async (refAll) => {
        const result = await axios.get(ipURL+ `ipURLfactElec/factElecs/ref=${refAll}`)
        setFacts(result.data)

    }

    const loadFactsRefP = async (refAllP) => {
        const result = await axios.get(ipURL+ `:8081/factElec/factElecsP/ref=${refAllP}`)
        setFactsP(result.data)

    }

    const loadFactsRefNP = async (refAllNP) => {
        const result = await axios.get(ipURL+ `:8081/factElec/factElecsNP/ref=${refAllNP}`)
        setFactsNP(result.data)
    ...
    const loadEntreprises = async () => {
        const result = await axios.get(ipURL+ ":8081/entreprise/entreprises");
    ...
    const loadClients = async () => {
        const result = await axios.get(ipURL+ ":8081/client/clients");
