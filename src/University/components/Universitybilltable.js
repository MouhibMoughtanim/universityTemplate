...
export default function Universitybilltable(){
  ...
  const putMethod = {
   ...
   fetch("http://localhost:2222/Univ-service/api/universityBill/putUniversityBill/"+universityBill.id, putMethod)
  ...
  function deleteClickk(university_bill_id) {
      //e.preventDefault()
      fetch('http://localhost:2222/Univ-service/api/universityBill/deleteUniversityBill/'+university_bill_id, {
          method: 'DELETE',
      ...
      console.log("http://localhost:2222/Univ-service/api/universityBill/deleteUniversityBill/"+universityBillId)
    }
  ...
  React.useEffect(() => {
    ...
    fetch("http://localhost:2222/Univ-service/api/universityBill/universityBillsById/" + university_id)
        .then(res => res.json())
        .then((result) => {
