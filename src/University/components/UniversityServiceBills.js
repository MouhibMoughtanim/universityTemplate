...
export default function UniversityServiceBills(props){
 ...
 const {university_id}= useParams();
  ...
  function search(e){
    console.log("http://localhost:2222/Univ-service/api/universityBill/universityBillsContains/"+e.value) 
   if(e.value == ""){
    fetch("http://localhost:2222/Univ-service/api/universityBill/allUniversitiesBills")
    .then(res => res.json())
    .then((result) => {
    ...
    fetch("http://localhost:2222/Univ-service/api/universityBill/universityBillsContains/"+e.value)
    .then(res => res.json())
    .then((result) => {
        setUniversityBills(result.filter(x =>x.university.id==university_id && x.university != null && x.client != null));
    }
  ...
  function pay(universitiesBill){
    ...
    fetch("http://localhost:2222/Univ-service/api/universityBill/universityBillByClientId/"+universitiesBill.client.id+"/orderBydate")
    .then(res => res.json())
    .then((result) => {
        ...
        if(universitiesBill.id != unpayedBills[0].id ){
          ...
          const putMethod = {
           ...
           fetch("http://localhost:2222/Univ-service/api/universityBill/putUniversityBill/"+universitiesBill.id, putMethod)
           .then((response) =>{
            response.json()
            let searchInput = document.getElementById('searchByReference')
            searchInput.value =""
  ...
  function searchByClient(id){
    ...
    if(id == "all"){
        ...
        fetch("http://localhost:2222/Univ-service/api/universityBill/universityBillByClientId/"+id)
            .then(res => res.json())
            .then((result) => {
            setUniversityBills(result.filter(x =>x.university.id==university_id && x.university != null && x.client != null));
            }
  ...
  React.useEffect(() => {
    ...
    fetch("http://localhost:2222/Univ-service/api/universityBill/universityBillsById/" + university_id)        .then(res => res.json())
        .then((result) => {
            setUniversityBills(result.filter(x => x.university != null && x.client != null));
        }
        )
        fetch("http://localhost:2222/Univ-service/api/client/allClients")
        .then(res => res.json())
        .then((result) => {
            setClients(result);
        }
