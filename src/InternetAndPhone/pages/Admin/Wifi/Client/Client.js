...
function Client() {
    ...
    const loadClients = async()=>{
        const all = await axios.get('http://localhost:2222/Phone-Internet/client/all')
        setClients(all.data)
    ...
    const confirmDeleteClient = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      await axios.delete('http://localhost:2222/Phone-Internet/client/delete?id='+id)
      loadClients()
    ...
    const editClient = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      const clientEdit = await axios.get('http://localhost:2222/Phone-Internet/client/get?id='+id)
      console.log('in edit')
    ...
    const updatePhone = async(e) => {
      ...
      console.log(client)
      await axios.post('http://localhost:2222/Phone-Internet/client/update', client)
      loadClients()
