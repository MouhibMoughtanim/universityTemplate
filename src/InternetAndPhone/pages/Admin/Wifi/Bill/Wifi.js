...
function Wifi() {
    ...
    const loadWifis = async()=>{
        const all = await axios.get('http://localhost:2222/Phone-Internet/wifi/all')
        setWifis(all.data)
        console.log(all.data)
    }

    const loadOperators = async()=>{
        const all = await axios.get('http://localhost:2222/Phone-Internet/operator/all')
      ...
      const search = async(e)=>{
        ...
        const some = await axios.get('http://localhost:2222/Phone-Internet/wifi/code/'+sid)
        setWifis(some.data)
    ...
    const confirmDeletePhone = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      await axios.delete('http://localhost:2222/Phone-Internet/wifi/delete?id='+id)
    ...
    const editWifi = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      const wifiEdit = await axios.get('http://localhost:2222/Phone-Internet/wifi/get?id='+id)
    ...
    const updateWifi = async(e) => {
      const wifi = {id}
      console.log(wifi)
      await axios.post('http://localhost:2222/Phone-Internet/wifi/update', wifi)
