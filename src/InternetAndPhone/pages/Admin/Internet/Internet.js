...
function Internet() {
    ...
    const loadInternets = async()=>{
        const all = await axios.get('http://localhost:2222/Phone-Internet/internet/all')
    ...
    const confirmDeleteInternet = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      await axios.delete('http://localhost:2222/Phone-Internet/internet/delete?id='+id)
    ...
    const editInternet = async(e) => {
      ...
      const internetEdit = await axios.get('http://localhost:2222/Phone-Internet/internet/get?id='+id)
    ...
    const updateInternet = async(e) => {
      ...
      await axios.post('http://localhost:2222/Phone-Internet/internet/update', internet)
