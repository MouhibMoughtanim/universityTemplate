...
function Phone() {
    ...
    const loadPhones = async()=>{
        const all = await axios.get('http://localhost:2222/Phone-Internet/phone/all')
        setPhones(all.data)
    ...
    const confirmDeletePhone = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      await axios.delete('http://localhost:2222/Phone-Internet/phone/delete?id='+id)
    ...
    const editPhone = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      const phoneEdit = await axios.get('http://localhost:2222/Phone-Internet/phone/get?id='+id)
    ...
    const updatePhone = async(e) => {
      ...
      console.log(phone)
      await axios.post('http://localhost:2222/Phone-Internet/phone/update', phone)
