...
const handleCreation = async(e) =>{
  ...
  setInternet((await axios.post('http://localhost:2222/Phone-Internet/internet/add',internet)).data)
...
const search = async(e)=>{
  ...
  const some = await axios.get('http://localhost:2222/wifi/code/'+sid)
  setWifis(some.data)
