...
export default function Card(props){
    const logoo = 'data:image/jpeg;base64,'+ props.university.logo
      ...
      const deleteClick =  (e)=>{
        //e.preventDefault()
        fetch('http://localhost:1949/api/university/deleteUniversity/'+props.university.id, {
            method: 'DELETE',
      ...
      const onSubmit =  (e)=>{
       ...
       const formData = new FormData();
        ...
        fetch('http://localhost:1949/api/university/putUniversity/'+localStorage.getItem('UniversityId'), {
            method: 'put',
            body: formData
        }).then(res => {
            if(res.ok) {
