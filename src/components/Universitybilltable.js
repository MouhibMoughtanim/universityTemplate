...
export default function Universitybilltable(){
  ...
  // console.log(`http://localhost:1949/api/universityBill/putUniversityBill/${universityBill.id}`)
  ...
  const putMethod = {
   ...
   fetch("http://localhost:1949/api/universityBill/putUniversityBill/"+universityBill.id, putMethod)
  ...
  function deleteClickk(university_bill_id) {
      //e.preventDefault()
      fetch('http://localhost:1949/api/universityBill/deleteUniversityBill/'+university_bill_id, {
          method: 'DELETE',
      ...
      console.log("http://localhost:1949/api/universityBill/deleteUniversityBill/"+universityBillId)
    }
  ...
  React.useEffect(() => {
    ...
    fetch("http://localhost:1949/api/universityBill/universityBillsById/" + university_id)
        .then(res => res.json())
        .then((result) => {
