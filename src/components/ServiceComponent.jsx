...
class ServiceComponent extends Component {
    ...
    viewEntroprise(entroprise_id){
        this.props.history.push(`/House_Car_Insurance/${entroprise_id}`);
        console.log("e n t")
...
<div className="container-xxl flex-grow-1 container-p-y">
  ...
  <div className="card h-100">
    <img className="card-img-top" src={'data:image/jpeg;base64,' + entroprise.logo} alt="Card" height="250px" width="130px"/>
    <div className="card-body">
